...
export const EDUCATION = [
  ...
  { name: '도커 및 쿠버네티스를 활용한 컨테이너 배포 및 운영기술', period: '2025.12 — 2026.01', note: '솔데스크 재직자 과정. 5일, 총 40시간 수료.' },
  { name: '파이썬 분석라이브러리 기반 데이터 분석', period: '2026.02 — 2026.03', note: '솔데스크 재직자 과정. 5일, 총 40시간 수료.' },
  { name: 'Jenkins를 활용한 CI/CD 환경구성', period: '2026.03', note: '솔데스크 재직자 과정. 2일, 총 16시간 수료.' },
]
