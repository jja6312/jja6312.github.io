...
export default function CommandPalette() {
  ...
  const cmds: Cmd[] = useMemo(() => [
    ...
    { id: 'ann', label: '지식모음 — OCI공지', kbd: 'g a', run: () => nav('/knowledge/announcements') },
    { id: 'cli', label: '지식모음 — OCI CLI 레시피', run: () => nav('/knowledge/oci-cli') },
    { id: 'tf', label: '지식모음 — Terraform', run: () => nav('/knowledge/terraform') },
    { id: 'quote', label: '지식모음 — 견적서 작성', kbd: 'g q', run: () => nav('/knowledge/quote') },
    { id: 'meetings', label: '회의록으로 이동', kbd: 'g m', run: () => nav('/meetings') },
